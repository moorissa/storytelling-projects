(function() {
  ...
  function ready(error, datapoints) {
    ...
    var maxRatingCount = d3.max(datapoints, function(d) {return +d.published})
    ...
    svg.selectAll("circle")
      ...
      .attr("cx", function(d) {
        return xPositionScale(d.published)
      })
      .attr("cy", function(d) {
  ...
  d3.select(".all")
    .on('click', function() {
      var NewmaxRatingCount = d3.max(datapoints, function(d) {
        return +d.published})
      xPositionScale.domain([1864, NewmaxRatingCount ])
      svg.selectAll('circle')
          .transition()
          .duration(1200)
      .style("opacity", 1)
    ...
    .attr("cy", function(d) {
      ...
      xPositionAxis.domain([1864,NewmaxRatingCount])
  ...
  d3.select(".hugoN")
    .on('click', function(d) {
      var hugo_nomineemax = d3.max(datapoints, function(d) {
        if (d.hugo_nominee == 'True') {return +d.published}
        else
        {return 0}
      });
      xPositionScale.domain([1864,hugo_nomineemax])
      svg.selectAll('circle')
        .transition()
        .duration(1200)
        ...
        xPositionAxis.domain([1864,hugo_nomineemax])
        svg.selectAll(".x-axis")
                .transition()
                .duration(1200)
                .call(xAxis)
  ...
  d3.select(".hugoW")
    .on('click', function(d) {
      var hugo_winnermax = d3.max(datapoints, function(d) {
        if (d.hugo_winner == 'True') {return +d.published}
        else
        {return 0}
      });
      xPositionScale.domain([1864,hugo_winnermax])
      svg.selectAll('circle')
        .transition()
        .duration(1200)
        .style("opacity", function(d) {
        ...
        xPositionAxis.domain([1864,hugo_winnermax])
        svg.selectAll(".x-axis")
                .transition()
                .duration(1200)
                .call(xAxis)
    ...
    d3.select(".nebulaN")
      .on('click', function(d) {
        var nebula_nomineemax = d3.max(datapoints, function(d) {
          if (d.nebula_nominee == 'True') {return +d.published}
          else
          {return 0}
        });
        xPositionScale.domain([1864,nebula_nomineemax])
        svg.selectAll('circle')
          .transition()
          .duration(1200)
          .style("opacity", function(d) {
          ...
          xPositionAxis.domain([1864,nebula_nomineemax])
          svg.selectAll(".x-axis")
                  .transition()
                  .duration(1200)
                  .call(xAxis)
    ...
    d3.select(".nebulaW")
      .on('click', function(d) {
        var nebula_winnermax = d3.max(datapoints, function(d) {
          if (d.nebula_winner == 'True') {return +d.published}
          else
          {return 0}
        });
        xPositionScale.domain([1864,nebula_winnermax])
        svg.selectAll('circle')
          .transition()
          .duration(1200)
          .style("opacity", function(d) {
          ...
          xPositionAxis.domain([1864,nebula_winnermax])
          svg.selectAll(".x-axis")
                  .transition()
                  .duration(1200)
                  .call(xAxis)
    ...
    d3.select(".no")
      .on('click', function(d) {
        ...
        xPositionScale.domain([1864,nomax])
        svg.selectAll('circle')
          .transition()
          .duration(1200)
          .style("opacity", function(d) {
          ...
          xPositionAxis.domain([1864,nomax])
          svg.selectAll(".x-axis")
                  .transition()
                  .duration(1200)
                  .call(xAxis)
    ...
    d3.select(".M")
      .on('click', function(d) {
        ...
        xPositionScale.domain([1864,malemax])
        svg.selectAll('circle')
          .transition()
          .duration(1200)
          .style("opacity", function(d) {
          ...
          xPositionAxis.domain([1864,malemax])
          svg.selectAll(".x-axis")
                  .transition()
                  .duration(1200)
                  .call(xAxis)
    ...
    d3.select(".F")
      .on('click', function(d) {
        ...
        xPositionScale.domain([1864,femalemax])
        svg.selectAll('circle')
          .transition()
          .duration(1200)
          .style("opacity", function(d) {
          ...
          xPositionAxis.domain([1864,femalemax])
          svg.selectAll(".x-axis")
                  .transition()
                  .duration(1200)
                  .call(xAxis)
